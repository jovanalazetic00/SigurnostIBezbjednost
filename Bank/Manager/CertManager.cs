...
namespace Manager
{
    public class CertManager  //klasa za dobavljanje sertifikata, sa vjezbi
    {
		...
		{   //poziva se samo kada servis kreira nalog, posto cer nisu jos instalirani, ucitava ih iz foldera sertifikati
